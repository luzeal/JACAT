...
Just like articles in Wikipedia, this presentation is free and open: you are free to copy it, to modify it, to share it, and even to sell it (if you remove comics, which cannot be sold).

Unlike articles on Wikipeida, it has not been reviewed. Don't take what is included in this presentation as face value. Use your judgment. 
-->
...
<!--
In this training, the cyber and information suffixes are used interchangeability (e.g information security and cybersecurity). Both suffixes refer to what is happening online.
...
- Distinction between digital hygiene in the personal and corporate setting

In a corporate setting like in INSO, you are working together with IT. They are here to protect you and the organization. At home, your Internet Service Provider is offering some help, but you are mainly on your own. 

Try to stay coherent between your home and the corporate environment 
-->
...
The most powerful cyber powers are neutral or friendly to Ukraine 
-->
...
<!--
APTs operating in the West are less known, and less studied. The Equation Group is believed to be associated to the NSA.
